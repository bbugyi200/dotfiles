...
Add a " (XhYmZs)" suffix to `| CHAT:` lines in HISTORY entries to show how long the associated agent took to run.
Duration is calculated from the timestamp embedded in the chat filename to when the HISTORY entry is created.
