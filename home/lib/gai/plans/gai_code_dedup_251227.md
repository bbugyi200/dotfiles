...
Create a new `gai_utils.py` module to consolidate duplicated utility functions across the codebase. The refactoring is
organized into phases by priority and risk.
...
The two loop runner scripts (`loop_crs_runner.py` ~224 lines, `loop_fix_hook_runner.py` ~223 lines) share significant
structure:
