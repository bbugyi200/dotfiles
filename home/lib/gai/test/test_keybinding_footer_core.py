...
def test_keybinding_footer_tmux_visible_wip() -> None:
    """Test 't' (tmux) binding is visible for WIP status."""
    footer = KeybindingFooter()
...
def test_keybinding_footer_tmux_visible_drafted() -> None:
    """Test 't' (tmux) binding is visible for Drafted status."""
    footer = KeybindingFooter()
    changespec = _make_changespec(status="Drafted")
...
def test_keybinding_footer_tmux_visible_mailed() -> None:
    """Test 't' (tmux) binding is visible for Mailed status."""
    footer = KeybindingFooter()
...
def test_keybinding_footer_tmux_hidden_reverted() -> None:
    """Test 't' (tmux) binding is hidden for Reverted status."""
    footer = KeybindingFooter()
...
def test_keybinding_footer_tmux_hidden_submitted() -> None:
    """Test 't' (tmux) binding is hidden for Submitted status."""
    footer = KeybindingFooter()
