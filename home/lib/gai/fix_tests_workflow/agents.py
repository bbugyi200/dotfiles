...
* @{artifacts_dir}/cl_changes.diff - A diff of this CL's changes"""
    ...
    # Add context log file if provided (for final retry)
...
* @{context_log_file} - Previous workflow attempts log"""
    ...
    # Add clsurf output if available
...
+ The @{artifacts_dir}/cl_desc.txt file contains this CL's description.
+ The @{artifacts_dir}/cl_changes.diff file contains a diff of this CL's changes.{design_docs_note}
