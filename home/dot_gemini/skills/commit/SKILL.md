...
4. **NEVER mention "Gemini" or "Gemini CLI" in commit messages** - write as if a human authored the commit

## Bead Association

Before committing, check if your work is associated with a bead issue:

1. Run `sase bead list --status=in_progress` to see beads currently in progress
