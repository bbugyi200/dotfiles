...
3. **Write a commit message file** — Create the file at `.sase/commit_message.md`, relative to the repository being
   ...
   commit finalizer and can never be swept into a whole-repository commit. **NEVER mention "Claude" or "Claude Code"** —
   write as if a human authored the commit. Do not preemptively stash, fast-forward, pull, or hand-sync before
