...
- `sase/memory/sase.md` is always generated by SASE and captures linked repositories
  plus workspace rules. `sase/memory/sase_beads.md` and its `sase/memory/sase_sizes.md`
  child are generated only for SASE-managed project repositories and provide shared bead
  workflow guidance.
