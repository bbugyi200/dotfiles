...
return {
	-- PLUGIN: http://github.com/stevearc/aerial.nvim
	{
		...
		keys = {
			-- KEYMAP: [{
			{ "[{", desc = "Jump to previous Aerial symbol." },
			-- KEYMAP: ]}
			{ "]}", desc = "Jump to next Aerial symbol." },
			-- KEYMAP: <leader>ae
			{ "<leader>ae", "<cmd>AerialToggle<cr>", desc = "Toggle aerial.nvim outline window." },
			-- KEYMAP: <leader>tae
			{ "<leader>tae", "<cmd>Telescope aerial<cr>", desc = "Telescope aerial" },
		},
		dependencies = {
